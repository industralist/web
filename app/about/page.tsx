    ...
    <div className="min-h-screen bg-black text-white">
      <section className="py-20 container mx-auto px-4">
        ...
        <div className="mt-12 space-y-12">
          ...
          <div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Set custom alerts for price thresholds, volume spikes,
                  liquidity changes, and more. Never miss a critical market
                  movement.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Access detailed charts, historical data, holder analytics, and
                  trading patterns to make data-driven decisions.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-orange-500 mb-2">
                ...
                <p className="text-gray-400 text-sm">
                  Integrate Piflepath's powerful analytics into your own
                  applications with our easy-to-use SDK and comprehensive API.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Technology */}
          <div>
            <h2 className="text-2xl font-bold mb-3">Built on Solana</h2>
            <p className="text-gray-400 leading-relaxed">
              We chose Solana for its unmatched speed and low transaction costs.
              Our infrastructure leverages Solana's high-performance blockchain
              to deliver real-time data processing and analytics that keep pace
              with the market. By building natively on Solana, we ensure our
              users have the fastest and most accurate data available.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white/5 border border-white/10 rounded-xl p-5">
                ...
                <p className="text-gray-400 text-sm">
                  Sub-second data updates ensuring you're always ahead of the
                  market.
                </p>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-5">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-5">
                ...
                <p className="text-gray-400 text-sm">
                  Track thousands of tokens with detailed metrics and historical
                  data.
                </p>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-xl p-5">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>
                  <strong className="text-white">Day Traders</strong> who need
                  real-time alerts and rapid market insights
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-orange-500 mr-3 mt-1">▸</span>
              ...
              <li className="flex items-start">
                <span className="text-orange-500 mr-3 mt-1">▸</span>
                <span>
                  <strong className="text-white">Portfolio Managers</strong>{" "}
                  tracking multiple tokens and managing risk
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-orange-500 mr-3 mt-1">▸</span>
                <span>
                  <strong className="text-white">Researchers</strong> analyzing
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              We envision a future where cryptocurrency trading and development
              are transparent, accessible, and data-driven. Piflepath is
              committed to continuous innovation, expanding our analytics
              capabilities, and supporting the growth of the Solana ecosystem.
              Join us as we build the next generation of blockchain analytics
              tools.
            </p>
          </div>
