...
import { ExternalLink, Eye, ArrowUpRight, ArrowDownLeft, ChevronLeft, ChevronRight } from "lucide-react"
...
export function TransactionExplorer({ walletAddress, onTransactionClick }: TransactionExplorerProps) {
  ...
  const getTabData = (): Transaction[] => {
    switch (activeTab) {
      case "transfers":
        return (wallet?.transfers as Transaction[]) || []
      case "defi":
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-500 truncate">
                        {holding.tokenName && holding.tokenName !== "Unknown Token"
                          ? holding.tokenName
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-b border-slate-700/50 hover:bg-transparent">
                  ...
                  <TableHead className="px-4 py-3 text-orange-400 font-semibold text-left">Instructions</TableHead>
                  <TableHead className="px-4 py-3 text-orange-400 font-semibold text-left">By</TableHead>
                  <TableHead className="px-4 py-3 text-orange-400 font-semibold text-right">Value (SOL)</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
