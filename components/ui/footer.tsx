      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="flex flex-col max-w-sm">
            <Link href="/" className="flex items-center gap-2 font-bold text-xl group mb-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              A modern on-chain intelligence platform for tracing wallet transactions with precision, speed, and
        ...
        <div className="border-t border-white/5 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-400 text-xs">© {new Date().getFullYear()} Pifflepath. All rights reserved.</p>

          <div className="flex items-center gap-6">
            {/* Twitter Icon */}
            <Link href="https://x.com" className="text-gray-400 hover:text-white transition" aria-label="Twitter">
              <Twitter className="w-5 h-5" />
            </Link>

            {/* GitHub Icon */}
            <Link href="https://github.com" className="text-gray-400 hover:text-white transition" aria-label="GitHub">
              <Github className="w-5 h-5" />
            </Link>

            {/* Contact Support (text link stays) */}
            <Link href="mailto:support@pifflepath.com" className="text-gray-400 hover:text-white text-sm transition">
              Contact Support
            </Link>
          </div>
        </div>
